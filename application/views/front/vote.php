                ...
                <div class="col-md-<?php echo $bootstrapColWidth; ?>">
                    <div style="margin-top: 60px" class="card bg-light text-center">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><b>Nama</b><br><?php echo $kandidat->nama ?></p>
                            <td><b>Visi</b><?php echo $kandidat->visi ?></td>
                            <td><b>Misi</b><?php echo $kandidat->misi ?></td>
                        </div>
                        <div class="card-footer">
                            <a href="<?php echo base_url('home/doVote/' . $kandidat->idkandidat) ?>" class="btn btn-flat btn-primary">Vote</a>
                        </div>
                    </div>
                </div>
            <?php
